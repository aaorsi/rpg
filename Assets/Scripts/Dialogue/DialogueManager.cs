    ...
    public sealed class DialogueManager : MonoBehaviour
    {
        ...
        public async void SubmitPlayerLineFromUi(string rawLine)
        {
            ...
            RunUi(() =>
            {
                ...
                {
                    TryAppendSyntheticSidekickFollowAction(_activeNpc.npcId, result.Payload, line);
        ...
        void TryAppendSyntheticSidekickFollowAction(string npcId, AssistantModelPayload payload, string lastPlayerLine)
        {
